    ...
    <div className="footer" id="footer">
      <div className="footer-content">
        <div className="footer-content-left">
          <div className="footer-logo" aria-label="Smart Ordering">
            <span className="brand-smart">Smart</span>
            <span className="brand-ordering">Ordering</span>
          </div>
          <p>
        ...
        <div className="footer-content-right">
          ...
          <ul>
            ...
            <li>contact@smartordering.com</li>
          </ul>
        </div>
      </div>
      <hr />
      <p className="footer-copyright">
        Copyright 2024 @ Smart Ordering - All Right Reserved.
      </p>
    </div>
  );
};
